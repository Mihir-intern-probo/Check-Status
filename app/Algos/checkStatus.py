        ...
        async with aiohttp.ClientSession() as session:
            ...
            for i in range(len(result)):
                ...
                if(res['isError']==False):
                    ...
                    res = requests.put(os.getenv('CANCEL_API')+f'{response[i][3]}?eventId={response[i][2]}', headers={'AUTHORIZATION': f'Bearer {os.getenv("AUTH_TOKEN")}', "appId": "in.probo.pro","x-device-os": "ANDROID","x-version-name": "5.38.3"})
